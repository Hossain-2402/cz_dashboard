  ...
  return (
    <div className="AddProductScreen">
      <div style={{ left: positionOfInputArea}}  className="new_product_input_area">
        ...
        <input type="text" className="leading_image_input" placeholder="Enter leading Image Link" />
      ...
      <div className="add_new_product_btn" onClick={()=>{addNewProductToDB()}}>Add New Product</div>
