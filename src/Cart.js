...
function Cart() {
  ...
  const [small_btn_background_color,set_small_btn_background_color] = useState("black");
  const [medium_btn_background_color,set_medium_btn_background_color] = useState("black");
  const [large_btn_background_color,set_large_btn_background_color] = useState("black");
  const [xl_btn_background_color,set_xl_btn_background_color] = useState("black");
    ...
    <div className="Cart">
      ...
      <div style={{ left: positionOfDetailArea}} className="detail_of_product_area">
        ...
        <div className="detail_info_area">
          ...
          <div className="sizes_header_text">Sizes</div>
          <div className="sizes_area">
            <div style={{ backgrsound: small_btn_background_color}} className="small_size_btn" onClick={()=>{smallSize()}}>S</div>
            <div style={{ backgrsound: medium_btn_background_color}} className="medium_size_btn" onClick={()=>{mediumSize()}}>M</div>
            <div style={{ backgrsound: large_btn_background_color}} className="large_size_btn" onClick={()=>{largeSize()}}>L</div>
            <div style={{ backgrsound: xl_btn_background_color}} className="xl_size_btn" onClick={()=>{xlSize()}}>XL</div>
          </div>
          ...
          {/*<div className="add_to_cart_btn" onClick={()=>{showCartItems()}}>Add to cart</div>*/}
        </div>
      </div>
